...
<body class="row" style="background-image: url(/asset/gunung.jpg);" onload="displayLocalDateTime()">
...
$data = $koneksi->query("SELECT * FROM  kasir");
$total1 = 0;
...
@endphp
                   ...
                   <tr align="center" >
                        ...
                        <td>{{ $a->qty}}</td>
                        <td class="diskon1">{{ $a->disc}}</td>
                        <td>{{ rupiah($a->totbar)}}</td>
                        <td class="acton1"><a href="/count/delete/{{$a->id}}" onclick="return confirm('Apakah Anda Yakin Menghapus Data?');" class="btn btn-danger btn-sm"><i class="fa fa-trash"></i></a>
...
@endphp
                        ...
                        <div class="form-group">
                           <td> <label class="col-lg-3 control-label">Kembali</label><td>
                            <div class="col-lg-3" style="padiing-right:20px;">
                               ...
                               <!--<td><a class="btn btn-danger new" href="{{route('count.delete.all')}}" role="button">[+]</a></td>-->
                            </div>
                        </div>
                    </tr>
                    </table>
            ...
            <div class="col-2" style="align-items: end;">
                    ...
                    <a class="btn btn-secondary cetak" onclick="printToPDF()" style="margin-top: 50px; " href="{{route('count.delete.all')}}" role="button" ><i class="fa fa-print" style="font-size:30px"></i></a>
